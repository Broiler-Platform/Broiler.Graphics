...
/// </summary>
public readonly record struct BFrameContext(BColor ClearColor, long FrameIndex, BRenderOptions Options)
{
    public BFrameContext(BColor clearColor) : this(clearColor, 0, BRenderOptions.Default) { }
