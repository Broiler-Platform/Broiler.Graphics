...
/// </summary>
public abstract class BWindow(BWindowOptions options) : IDisposable
{
    private bool _disposed;

    public BWindowOptions Options { get; } = options ?? throw new ArgumentNullException(nameof(options));
    ...
    protected virtual void ShowCore() => throw new NotSupportedException("This window backend does not support Show().");
    ...
    protected virtual BFrameContext CreateFrameContext(long frameIndex) => new(Options.ClearColor, frameIndex, Options.RenderOptions);
